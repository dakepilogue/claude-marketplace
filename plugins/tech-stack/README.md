...
# Add Spring Boot best practices to your project
/tech-stack:add-springboot-best-practices
...
- [/tech-stack:add-springboot-best-practices](./add-springboot-best-practices.md) - Sets up Spring Boot best practices and code style rules in your CLAUDE.md file, providing Claude with explicit guidelines for generating consistent, type-safe code.
